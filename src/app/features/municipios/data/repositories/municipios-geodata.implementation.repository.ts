...
import { MunicipiosCsvMapper } from "./mappers/municipios-csv.mapper";
    ...
    implements MunicipioGeoDataRepository
{
    ...
    municipiosCsvMapper: MunicipiosCsvMapper = new MunicipiosCsvMapper();
    ...
    getCSVData(vendorFile: string): Observable<any> {
        ...
        return this.http
            ...
            .pipe(map(this.municipiosCsvMapper.mapFrom));
    }
